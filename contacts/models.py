...
class Contact(models.Model):
  ...
  email: models.CharField[str | None] = models.CharField(max_length=128, blank=True, null=True)
  phone: models.CharField[str | None] = models.CharField(max_length=128, blank=True, null=True)
